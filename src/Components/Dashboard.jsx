...
import ToDoList from './To_dolist.jsx';
    ...
    const styles = {
        root: {
        minHeight: '100vh',
        minWidth: '100vw', // Ajoute cette ligne pour occuper toute la largeur
        width: '100vw',    // Ajoute cette ligne pour forcer le plein écran horizontal
        ...
        padding: 0,
        margin: 0, // Ajoute cette ligne pour supprimer toute marge
        boxSizing: 'border-box', // Ajoute cette ligne pour éviter les débordements
        },
        tabs: {
        display: 'flex',
        gap: 8,
    ...
    return (
        ...
        <div style={{width: '100%', maxWidth: 1150}}>
            ...
            {activeTab === 'todo'
            ? <ToDoList styles={styles} STATUS={STATUS} setShowModal={setShowModal} />
            : <Table />}
        </div>
        {showModal && <Modal />}
