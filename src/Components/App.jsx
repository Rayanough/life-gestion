...
function DayView({ styles, theme, openModal }) {
  ...
  return (
    <>
      <div style={{ display: 'flex', gap: 10, marginBottom: 20, overflowX: 'hidden', paddingBottom: 6 }}>
        {DAILY_DATA.map(day => (
          <button
            key={day.id}
            style={{
...
function App() {
  ...
  tabContent: {
    ...
    flexDirection: 'column',
    padding: '0 16px',
    overflowY: 'visible', // Permet au contenu de s'étendre sans défilement interne
  },
  tableWrapper: {
    width: '100%',
    maxWidth: '100%',
    ...
    marginBottom: 24,
    // Suppression de maxHeight: '70vh' et overflowY: 'auto' pour éviter le défilement interne
  },
  table: {
    width: '100%',
    ...
    {theme === 'dark' ? '☀️' : '🌙'}
      ...
      <header style={styles.header}>
        ...
        <p style={styles.subtitle}>
           Tu ne bâtis pas juste une entreprise, tu conçois un système qui rend ta liberté inévitable.
        </p>
      </header>
